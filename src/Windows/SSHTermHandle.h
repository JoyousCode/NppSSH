...
public:
    ...
    void disConnection();
    void resetSSHTermHandle();
    void SizeSSHTermHandle(HWND hParent);
    ...
    void SetStoreContent(const std::wstring& lastLineStr) { _oldStoreContent = lastLineStr; }
    //void SetAppendStoreContent(const std::wstring wstr) { _oldStoreContent = std::move(wstr); }
